...
late List<Rating> clientRatings = [];
  ...
  void _showRatingModal(BuildContext outerContext, ServiceProvider serviceProvider) {
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return Dialog(
          ...
          child: contentBox(context, outerContext, serviceProvider, qualityOfService,
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      bool success = await saveRating(outerContext,qualityOfService, disciplineRating,
  ...
  Future<bool> saveRating(BuildContext context,double qualityOfService, double disciplineRating,
    ...
    try {
     ...
     String errorMessage = 'Failed to create a rate for a provider.';
    if (e is ApiException) {
      print("the error is ${e.message}");
      if (e.message == 'You can only add a review once.') {
        errorMessage = e.message;
      }
    }
    print('Failed to create a rate for a provider: $errorMessage');
    ScaffoldMessenger.of(context).showSnackBar(
